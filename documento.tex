...
\ies{\phantom{Universidade Estadual do Ceará}}
\iessigla{ProDEd-TS}
\centro{\phantom{Centro de Ciências e Tecnologia}}
...
\especializacaoem{Programa de Extensão Desenvolvimento e Educação Theotonio dos Santos}
...
\titulo{O PAPEL DA EDUCAÇÃO NA BUSCA PELA EMANCIPAÇÃO TECNOLÓGICA}
\data{2021}
...
\begin{document}	
	...
	\input{elementos-textuais/dependencia}
	\input{elementos-textuais/importancia}
	\input{elementos-textuais/politica}
